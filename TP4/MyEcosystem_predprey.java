...
public class MyEcosystem_predprey extends CAtoolbox {
	...
	public static void main(String[] args) {
		...
		for ( int i = 0 ; i != 10 ; i++ )
			world.add(new PreyAgent((int)(Math.random()*dx),(int)(Math.random()*dy),world,reprodPrey));
		for ( int i = 0 ; i != 10 ; i++ )
			world.add(new PredatorAgent((int)(Math.random()*dx),(int)(Math.random()*dy),world,reprodPredator,deathPredator));
